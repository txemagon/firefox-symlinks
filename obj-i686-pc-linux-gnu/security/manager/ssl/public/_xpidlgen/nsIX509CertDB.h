/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/security/manager/ssl/public/nsIX509CertDB.idl
 */
...
#define NS_IX509CERTDB_IID_STR "a18df2a5-84a9-46cd-9140-3fdb3879d9ff"

#define NS_IX509CERTDB_IID \
  {0xa18df2a5, 0x84a9, 0x46cd, \
    { 0x91, 0x40, 0x3f, 0xdb, 0x38, 0x79, 0xd9, 0xff }}
...
class NS_NO_VTABLE nsIX509CertDB : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetIsOcspOn(bool *aIsOcspOn) = 0;
...
#define NS_DECL_NSIX509CERTDB \
  ...
  NS_IMETHOD GetIsOcspOn(bool *aIsOcspOn); \
...
#define NS_FORWARD_NSIX509CERTDB(_to) \
  ...
  NS_IMETHOD GetIsOcspOn(bool *aIsOcspOn) { return _to GetIsOcspOn(aIsOcspOn); } \
...
#define NS_FORWARD_SAFE_NSIX509CERTDB(_to) \
  ...
  NS_IMETHOD GetIsOcspOn(bool *aIsOcspOn) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsOcspOn(aIsOcspOn); } \
