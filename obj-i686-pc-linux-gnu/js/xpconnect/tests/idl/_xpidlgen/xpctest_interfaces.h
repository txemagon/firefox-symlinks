/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/js/xpconnect/tests/idl/xpctest_interfaces.idl
 */
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsXPCTestInterfaceA, nsIXPCTestInterfaceA)
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsXPCTestInterfaceB, nsIXPCTestInterfaceB)
...
#define NS_DECL_NSIXPCTESTINTERFACEC \
  NS_IMETHOD GetSomeInteger(int32_t *aSomeInteger); \
  NS_IMETHOD SetSomeInteger(int32_t aSomeInteger); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXPCTESTINTERFACEC(_to) \
  NS_IMETHOD GetSomeInteger(int32_t *aSomeInteger) { return _to GetSomeInteger(aSomeInteger); } \
  NS_IMETHOD SetSomeInteger(int32_t aSomeInteger) { return _to SetSomeInteger(aSomeInteger); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXPCTESTINTERFACEC(_to) \
  NS_IMETHOD GetSomeInteger(int32_t *aSomeInteger) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSomeInteger(aSomeInteger); } \
  NS_IMETHOD SetSomeInteger(int32_t aSomeInteger) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSomeInteger(aSomeInteger); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsXPCTestInterfaceC, nsIXPCTestInterfaceC)
