/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/js/xpconnect/idl/nsIXPCScriptable.idl
 */
...
class NS_NO_VTABLE nsIXPCScriptable : public nsISupports {
 public: 
  ...
  NS_IMETHOD Equality(nsIXPConnectWrappedNative *wrapper, JSContext *cx, JSObject *obj, const JS::Value & val, bool *_retval) = 0;
...
#define NS_DECL_NSIXPCSCRIPTABLE \
  ...
  NS_IMETHOD Equality(nsIXPConnectWrappedNative *wrapper, JSContext *cx, JSObject *obj, const JS::Value & val, bool *_retval); \
...
#define NS_FORWARD_NSIXPCSCRIPTABLE(_to) \
  ...
  NS_IMETHOD Equality(nsIXPConnectWrappedNative *wrapper, JSContext *cx, JSObject *obj, const JS::Value & val, bool *_retval) { return _to Equality(wrapper, cx, obj, val, _retval); } \
...
#define NS_FORWARD_SAFE_NSIXPCSCRIPTABLE(_to) \
  ...
  NS_IMETHOD Equality(nsIXPConnectWrappedNative *wrapper, JSContext *cx, JSObject *obj, const JS::Value & val, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Equality(wrapper, cx, obj, val, _retval); } \
...
/* boolean equality (in nsIXPConnectWrappedNative wrapper, in JSContextPtr cx, in JSObjectPtr obj, in jsval val); */
NS_IMETHODIMP nsXPCScriptable::Equality(nsIXPConnectWrappedNative *wrapper, JSContext *cx, JSObject *obj, const JS::Value & val, bool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
