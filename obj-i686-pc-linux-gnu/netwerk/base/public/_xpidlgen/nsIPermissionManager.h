/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/netwerk/base/public/nsIPermissionManager.idl
 */
...
#define NS_IPERMISSIONMANAGER_IID_STR "6c68cd87-4569-4695-8bc8-ad609f624b96"

#define NS_IPERMISSIONMANAGER_IID \
  {0x6c68cd87, 0x4569, 0x4695, \
    { 0x8b, 0xc8, 0xad, 0x60, 0x9f, 0x62, 0x4b, 0x96 }}
...
class NS_NO_VTABLE nsIPermissionManager : public nsISupports {
 public: 
  ...
  NS_IMETHOD RemovePermissionsForApp(uint32_t appId) = 0;
...
#define NS_DECL_NSIPERMISSIONMANAGER \
  ...
  NS_IMETHOD RemovePermissionsForApp(uint32_t appId); 
...
#define NS_FORWARD_NSIPERMISSIONMANAGER(_to) \
  ...
  NS_IMETHOD RemovePermissionsForApp(uint32_t appId) { return _to RemovePermissionsForApp(appId); } 
...
#define NS_FORWARD_SAFE_NSIPERMISSIONMANAGER(_to) \
  ...
  NS_IMETHOD RemovePermissionsForApp(uint32_t appId) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemovePermissionsForApp(appId); } 
...
/* void removePermissionsForApp (in unsigned long appId); */
NS_IMETHODIMP nsPermissionManager::RemovePermissionsForApp(uint32_t appId)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
