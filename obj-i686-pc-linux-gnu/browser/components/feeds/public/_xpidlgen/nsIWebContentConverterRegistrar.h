/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/browser/components/feeds/public/nsIWebContentConverterRegistrar.idl
 */
...
#define NS_DECL_NSIWEBCONTENTHANDLERINFO \
  ...
  NS_IMETHOD GetHandlerURI(const nsAString & uri, nsAString & _retval); 
...
#define NS_FORWARD_NSIWEBCONTENTHANDLERINFO(_to) \
  ...
  NS_IMETHOD GetHandlerURI(const nsAString & uri, nsAString & _retval) { return _to GetHandlerURI(uri, _retval); } 
...
#define NS_FORWARD_SAFE_NSIWEBCONTENTHANDLERINFO(_to) \
  ...
  NS_IMETHOD GetHandlerURI(const nsAString & uri, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHandlerURI(uri, _retval); } 
...
#define NS_DECL_NSIWEBCONTENTCONVERTERSERVICE \
  NS_IMETHOD SetAutoHandler(const nsAString & contentType, nsIWebContentHandlerInfo *handler); \
  NS_IMETHOD GetAutoHandler(const nsAString & contentType, nsIWebContentHandlerInfo * *_retval); \
  NS_IMETHOD GetWebContentHandlerByURI(const nsAString & contentType, const nsAString & uri, nsIWebContentHandlerInfo * *_retval); \
  NS_IMETHOD LoadPreferredHandler(nsIRequest *request); \
  NS_IMETHOD RemoveProtocolHandler(const nsAString & protocol, const nsAString & uri); \
  NS_IMETHOD RemoveContentHandler(const nsAString & contentType, const nsAString & uri); \
  NS_IMETHOD GetContentHandlers(const nsAString & contentType, uint32_t *count, nsIWebContentHandlerInfo * **handlers); \
  NS_IMETHOD ResetHandlersForType(const nsAString & contentType); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWEBCONTENTCONVERTERSERVICE(_to) \
  NS_IMETHOD SetAutoHandler(const nsAString & contentType, nsIWebContentHandlerInfo *handler) { return _to SetAutoHandler(contentType, handler); } \
  NS_IMETHOD GetAutoHandler(const nsAString & contentType, nsIWebContentHandlerInfo * *_retval) { return _to GetAutoHandler(contentType, _retval); } \
  NS_IMETHOD GetWebContentHandlerByURI(const nsAString & contentType, const nsAString & uri, nsIWebContentHandlerInfo * *_retval) { return _to GetWebContentHandlerByURI(contentType, uri, _retval); } \
  NS_IMETHOD LoadPreferredHandler(nsIRequest *request) { return _to LoadPreferredHandler(request); } \
  NS_IMETHOD RemoveProtocolHandler(const nsAString & protocol, const nsAString & uri) { return _to RemoveProtocolHandler(protocol, uri); } \
  NS_IMETHOD RemoveContentHandler(const nsAString & contentType, const nsAString & uri) { return _to RemoveContentHandler(contentType, uri); } \
  NS_IMETHOD GetContentHandlers(const nsAString & contentType, uint32_t *count, nsIWebContentHandlerInfo * **handlers) { return _to GetContentHandlers(contentType, count, handlers); } \
  NS_IMETHOD ResetHandlersForType(const nsAString & contentType) { return _to ResetHandlersForType(contentType); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWEBCONTENTCONVERTERSERVICE(_to) \
  NS_IMETHOD SetAutoHandler(const nsAString & contentType, nsIWebContentHandlerInfo *handler) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAutoHandler(contentType, handler); } \
  NS_IMETHOD GetAutoHandler(const nsAString & contentType, nsIWebContentHandlerInfo * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAutoHandler(contentType, _retval); } \
  NS_IMETHOD GetWebContentHandlerByURI(const nsAString & contentType, const nsAString & uri, nsIWebContentHandlerInfo * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWebContentHandlerByURI(contentType, uri, _retval); } \
  NS_IMETHOD LoadPreferredHandler(nsIRequest *request) { return !_to ? NS_ERROR_NULL_POINTER : _to->LoadPreferredHandler(request); } \
  NS_IMETHOD RemoveProtocolHandler(const nsAString & protocol, const nsAString & uri) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveProtocolHandler(protocol, uri); } \
  NS_IMETHOD RemoveContentHandler(const nsAString & contentType, const nsAString & uri) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveContentHandler(contentType, uri); } \
  NS_IMETHOD GetContentHandlers(const nsAString & contentType, uint32_t *count, nsIWebContentHandlerInfo * **handlers) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetContentHandlers(contentType, count, handlers); } \
  NS_IMETHOD ResetHandlersForType(const nsAString & contentType) { return !_to ? NS_ERROR_NULL_POINTER : _to->ResetHandlersForType(contentType); } 
