...
Makefile: $(topsrcdir)/media/webrtc/signaling/signaling.gyp $(topsrcdir)/media/webrtc/trunk/tools/gyp/pylib/gyp/generator/mozmake.py
	$(PYTHON) $(topsrcdir)/media/webrtc/trunk/build/gyp_chromium --format=mozmake --include=/home/txema/work/firefox-20.0+build1/media/webrtc/webrtc_config.gypi --depth=$(topsrcdir)/media/webrtc/trunk --generator-output=$(DEPTH)/media/webrtc/signaling --toplevel-dir=$(topsrcdir) -G OBJDIR=$(DEPTH) -Dbuild_with_mozilla=1 -DFORCED_INCLUDE_FILE=/home/txema/work/firefox-20.0+build1/media/webrtc/webrtc_config.gypi -Dtarget_arch=ia32 -Dbuild_for_test=0 $(topsrcdir)/media/webrtc/signaling/signaling.gyp
