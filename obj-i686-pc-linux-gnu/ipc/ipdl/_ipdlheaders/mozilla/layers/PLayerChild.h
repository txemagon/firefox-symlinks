...
#ifndef PLayerChild_h
#define PLayerChild_h
...
class /*NS_ABSTRACT_CLASS*/ PLayerChild :
...
public:
    ...
    static bool
    Send__delete__(PLayerChild* actor);
...
{
    MOZ_COUNT_CTOR(LayerChild);
}

LayerChild::~LayerChild()
{
    MOZ_COUNT_DTOR(LayerChild);
}
