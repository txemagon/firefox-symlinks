...
#ifndef PCookieServiceParent_h
#define PCookieServiceParent_h
...
class /*NS_ABSTRACT_CLASS*/ PCookieServiceParent :
...
bool
CookieServiceParent::RecvSetCookieString(
        const URIParams& host,
        const bool& isForeign,
        const nsCString& cookieString,
        const nsCString& serverTime,
...
{
    MOZ_COUNT_CTOR(CookieServiceParent);
}

CookieServiceParent::~CookieServiceParent()
{
    MOZ_COUNT_DTOR(CookieServiceParent);
}
...
#endif // ifndef PCookieServiceParent_h
