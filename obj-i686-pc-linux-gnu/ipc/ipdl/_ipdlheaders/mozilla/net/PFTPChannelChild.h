...
#ifndef PFTPChannelChild_h
#define PFTPChannelChild_h
...
class /*NS_ABSTRACT_CLASS*/ PFTPChannelChild :
...
protected:
    ...
    virtual bool
    RecvFailedAsyncOpen(const nsresult& statusCode) = 0;
    virtual bool
    RecvDeleteSelf() = 0;
...
public:
    ...
    static bool
    Send__delete__(PFTPChannelChild* actor);
...
namespace mozilla {
namespace net {
class FTPChannelChild :
    public PFTPChannelChild
{
    virtual bool
    RecvOnStartRequest(
            const int64_t& aContentLength,
    ...
    virtual bool
    RecvFailedAsyncOpen(const nsresult& statusCode);
...
namespace net {
bool
FTPChannelChild::RecvOnStartRequest(
        const int64_t& aContentLength,
        const nsCString& aContentType,
        const PRTime& aLastModified,
        const nsCString& aEntityID,
...
bool
FTPChannelChild::RecvOnDataAvailable(
        const nsCString& data,
        const uint64_t& offset,
        const uint32_t& count)
{
...
{
    MOZ_COUNT_CTOR(FTPChannelChild);
}

FTPChannelChild::~FTPChannelChild()
{
    MOZ_COUNT_DTOR(FTPChannelChild);
}
...
#endif // ifndef PFTPChannelChild_h
