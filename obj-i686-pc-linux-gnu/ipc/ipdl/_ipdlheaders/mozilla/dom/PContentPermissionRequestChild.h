...
#ifndef PContentPermissionRequestChild_h
#define PContentPermissionRequestChild_h
...
class /*NS_ABSTRACT_CLASS*/ PContentPermissionRequestChild :
...
protected:
    ...
    typedef PContentPermissionRequest::State State;

    virtual bool
    Recv__delete__(const bool& allow);
...
namespace mozilla {
namespace dom {
class ContentPermissionRequestChild :
    public PContentPermissionRequestChild
{
    ContentPermissionRequestChild();
    virtual ~ContentPermissionRequestChild();
};
} // namespace dom
} // namespace mozilla
...
namespace mozilla {
namespace dom {
ContentPermissionRequestChild::ContentPermissionRequestChild()
{
    MOZ_COUNT_CTOR(ContentPermissionRequestChild);
}

ContentPermissionRequestChild::~ContentPermissionRequestChild()
{
    MOZ_COUNT_DTOR(ContentPermissionRequestChild);
}
...
#endif // ifndef PContentPermissionRequestChild_h
