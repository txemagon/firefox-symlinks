...
#ifndef PBlobStreamChild_h
#define PBlobStreamChild_h
...
class /*NS_ABSTRACT_CLASS*/ PBlobStreamChild :
...
namespace mozilla {
namespace dom {
class BlobStreamChild :
    public PBlobStreamChild
{
    BlobStreamChild();
    virtual ~BlobStreamChild();
};
} // namespace dom
} // namespace mozilla
...
namespace mozilla {
namespace dom {
BlobStreamChild::BlobStreamChild()
{
    MOZ_COUNT_CTOR(BlobStreamChild);
}

BlobStreamChild::~BlobStreamChild()
{
    MOZ_COUNT_DTOR(BlobStreamChild);
}
...
#endif // ifndef PBlobStreamChild_h
