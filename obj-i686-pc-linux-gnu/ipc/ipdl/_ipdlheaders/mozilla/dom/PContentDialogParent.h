...
#ifndef PContentDialogParent_h
#define PContentDialogParent_h

#include "mozilla/dom/PContentDialog.h"
namespace mozilla {
namespace dom {
...
class /*NS_ABSTRACT_CLASS*/ PContentDialogParent :
...
protected:
    ...
    typedef PContentDialog::State State;
...
public:
    ...
    Send__delete__(
            ...
            const InfallibleTArray<nsString>& aStringParams) NS_WARN_UNUSED_RESULT;
...
namespace mozilla {
namespace dom {
class ContentDialogParent :
    public PContentDialogParent
{
    ContentDialogParent();
    virtual ~ContentDialogParent();
};
} // namespace dom
} // namespace mozilla
...
namespace mozilla {
namespace dom {
ContentDialogParent::ContentDialogParent()
{
    MOZ_COUNT_CTOR(ContentDialogParent);
}

ContentDialogParent::~ContentDialogParent()
{
    MOZ_COUNT_DTOR(ContentDialogParent);
}
...
#endif // ifndef PContentDialogParent_h
