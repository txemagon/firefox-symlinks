...
#ifndef PMemoryReportRequestParent_h
#define PMemoryReportRequestParent_h
...
class /*NS_ABSTRACT_CLASS*/ PMemoryReportRequestParent :
...
protected:
    ...
    virtual bool
    Recv__delete__(const InfallibleTArray<MemoryReport>& report);
...
namespace mozilla {
namespace dom {
class MemoryReportRequestParent :
    public PMemoryReportRequestParent
{
...
#endif // ifndef PMemoryReportRequestParent_h
