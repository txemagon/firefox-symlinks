...
#ifndef PIndexedDBDeleteDatabaseRequestChild_h
#define PIndexedDBDeleteDatabaseRequestChild_h
...
class /*NS_ABSTRACT_CLASS*/ PIndexedDBDeleteDatabaseRequestChild :
...
protected:
    ...
    virtual bool
    Recv__delete__(const nsresult& rv);
    virtual bool
    RecvBlocked(const uint64_t& currentVersion) = 0;
...
{
    virtual bool
    RecvBlocked(const uint64_t& currentVersion);
...
namespace indexedDB {
bool
IndexedDBDeleteDatabaseRequestChild::RecvBlocked(const uint64_t& currentVersion)
{
    return false;
}
...
#endif // ifndef PIndexedDBDeleteDatabaseRequestChild_h
