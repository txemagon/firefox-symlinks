...
#ifndef PContentDialogChild_h
#define PContentDialogChild_h
...
class /*NS_ABSTRACT_CLASS*/ PContentDialogChild :
...
namespace mozilla {
namespace dom {
class ContentDialogChild :
    public PContentDialogChild
{
    ContentDialogChild();
    virtual ~ContentDialogChild();
};
} // namespace dom
} // namespace mozilla
...
namespace mozilla {
namespace dom {
ContentDialogChild::ContentDialogChild()
{
    MOZ_COUNT_CTOR(ContentDialogChild);
}

ContentDialogChild::~ContentDialogChild()
{
    MOZ_COUNT_DTOR(ContentDialogChild);
}
...
#endif // ifndef PContentDialogChild_h
