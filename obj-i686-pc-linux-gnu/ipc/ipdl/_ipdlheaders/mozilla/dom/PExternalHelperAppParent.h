...
class /*NS_ABSTRACT_CLASS*/ PExternalHelperAppParent :
...
public:
    ...
    bool
    SendCancel(const nsresult& aStatus) NS_WARN_UNUSED_RESULT;

    static bool
    Send__delete__(PExternalHelperAppParent* actor) NS_WARN_UNUSED_RESULT;
...
{
    virtual bool
    RecvOnStartRequest(const nsCString& entityID);
    ...
    virtual bool
    RecvOnStopRequest(const nsresult& code);
...
{
    MOZ_COUNT_CTOR(ExternalHelperAppParent);
}

ExternalHelperAppParent::~ExternalHelperAppParent()
{
    MOZ_COUNT_DTOR(ExternalHelperAppParent);
}
