...
#ifndef PBluetoothRequestParent_h
#define PBluetoothRequestParent_h
...
class /*NS_ABSTRACT_CLASS*/ PBluetoothRequestParent :
...
public:
    ...
    Send__delete__(
            ...
            const BluetoothReply& response) NS_WARN_UNUSED_RESULT;
...
namespace dom {
namespace bluetooth {
class BluetoothRequestParent :
    public PBluetoothRequestParent
{
...
#endif // ifndef PBluetoothRequestParent_h
