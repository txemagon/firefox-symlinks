...
#ifndef PBluetoothRequest_h
#define PBluetoothRequest_h
...
//-----------------------------------------------------------------------------
// Code common to PBluetoothRequestChild and PBluetoothRequestParent
//
namespace mozilla {
namespace dom {
namespace bluetooth {
namespace PBluetoothRequest {
...
enum MessageType {
    PBluetoothRequestStart = PBluetoothRequestMsgStart << 16,
    PBluetoothRequestPreStart = (PBluetoothRequestMsgStart << 16) - 1,
    Msg___delete____ID,
    Reply___delete____ID,
    PBluetoothRequestEnd
};
...
public:
    ...
    Msg___delete__() :
        IPC::Message(MSG_ROUTING_NONE, ID, PRIORITY_NORMAL, COMPRESSION_NONE, "PBluetoothRequest::Msg___delete__")
    {
    }
...
public:
    ...
    Reply___delete__() :
        IPC::Message(MSG_ROUTING_NONE, ID, PRIORITY_NORMAL, COMPRESSION_NONE, "PBluetoothRequest::Reply___delete__")
    {
    }
...
#endif // ifndef PBluetoothRequest_h
