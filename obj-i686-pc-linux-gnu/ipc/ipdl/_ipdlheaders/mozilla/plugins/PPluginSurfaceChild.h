...
#ifndef PPluginSurfaceChild_h
#define PPluginSurfaceChild_h
...
class /*NS_ABSTRACT_CLASS*/ PPluginSurfaceChild :
...
public:
    ...
    static bool
    Send__delete__(PPluginSurfaceChild* actor);
...
namespace mozilla {
namespace plugins {
class PluginSurfaceChild :
    public PPluginSurfaceChild
{
    PluginSurfaceChild();
    virtual ~PluginSurfaceChild();
};
} // namespace plugins
} // namespace mozilla
...
namespace mozilla {
namespace plugins {
PluginSurfaceChild::PluginSurfaceChild()
{
    MOZ_COUNT_CTOR(PluginSurfaceChild);
}

PluginSurfaceChild::~PluginSurfaceChild()
{
    MOZ_COUNT_DTOR(PluginSurfaceChild);
}
...
#endif // ifndef PPluginSurfaceChild_h
