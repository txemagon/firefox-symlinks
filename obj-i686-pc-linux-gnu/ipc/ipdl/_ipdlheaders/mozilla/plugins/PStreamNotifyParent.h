...
#ifndef PStreamNotifyParent_h
#define PStreamNotifyParent_h
...
class /*NS_ABSTRACT_CLASS*/ PStreamNotifyParent :
...
protected:
    ...
    virtual bool
    RecvRedirectNotifyResponse(const bool& allow) = 0;
...
public:
    ...
    SendRedirectNotify(
            const nsCString& url,
            const int32_t& status) NS_WARN_UNUSED_RESULT;

    static bool
    Send__delete__(
            PStreamNotifyParent* actor,
            const NPReason& reason) NS_WARN_UNUSED_RESULT;
...
class StreamNotifyParent :
    public PStreamNotifyParent
{
    virtual bool
    RecvRedirectNotifyResponse(const bool& allow);

    StreamNotifyParent();
    virtual ~StreamNotifyParent();
};
} // namespace plugins
} // namespace mozilla
...
StreamNotifyParent::StreamNotifyParent()
{
    MOZ_COUNT_CTOR(StreamNotifyParent);
}

StreamNotifyParent::~StreamNotifyParent()
{
    MOZ_COUNT_DTOR(StreamNotifyParent);
}
...
#endif // ifndef PStreamNotifyParent_h
