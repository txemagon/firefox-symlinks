...
#ifndef PPluginIdentifierChild_h
#define PPluginIdentifierChild_h
...
class /*NS_ABSTRACT_CLASS*/ PPluginIdentifierChild :
...
namespace mozilla {
namespace plugins {
PluginIdentifierChild::PluginIdentifierChild()
{
...
#endif // ifndef PPluginIdentifierChild_h
