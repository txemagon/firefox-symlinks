...
#ifndef PPluginBackgroundDestroyerChild_h
#define PPluginBackgroundDestroyerChild_h
...
class /*NS_ABSTRACT_CLASS*/ PPluginBackgroundDestroyerChild :
...
public:
    ...
    static bool
    Send__delete__(PPluginBackgroundDestroyerChild* actor);
...
namespace mozilla {
namespace plugins {
class PluginBackgroundDestroyerChild :
    public PPluginBackgroundDestroyerChild
{
...
namespace mozilla {
namespace plugins {
PluginBackgroundDestroyerChild::PluginBackgroundDestroyerChild()
{
    MOZ_COUNT_CTOR(PluginBackgroundDestroyerChild);
}

PluginBackgroundDestroyerChild::~PluginBackgroundDestroyerChild()
{
    MOZ_COUNT_DTOR(PluginBackgroundDestroyerChild);
}
...
#endif // ifndef PPluginBackgroundDestroyerChild_h
