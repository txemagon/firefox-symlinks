/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/content/base/public/nsIMessageManager.idl
 */
...
/* starting interface:    nsIPermissionChecker */
#define NS_IPERMISSIONCHECKER_IID_STR "5f552699-01a2-4f17-833b-ddb3fa0d98b2"

#define NS_IPERMISSIONCHECKER_IID \
  {0x5f552699, 0x01a2, 0x4f17, \
    { 0x83, 0x3b, 0xdd, 0xb3, 0xfa, 0x0d, 0x98, 0xb2 }}

class NS_NO_VTABLE nsIPermissionChecker : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IPERMISSIONCHECKER_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIPermissionChecker, NS_IPERMISSIONCHECKER_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIPERMISSIONCHECKER \
  NS_IMETHOD AssertPermission(const nsAString & aPermission, bool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPERMISSIONCHECKER(_to) \
  NS_IMETHOD AssertPermission(const nsAString & aPermission, bool *_retval) { return _to AssertPermission(aPermission, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPERMISSIONCHECKER(_to) \
...
/* Header file */
class nsPermissionChecker : public nsIPermissionChecker
{
public:
  NS_DECL_ISUPPORTS
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsPermissionChecker, nsIPermissionChecker)
...
/* boolean assertPermission (in DOMString aPermission); */
NS_IMETHODIMP nsPermissionChecker::AssertPermission(const nsAString & aPermission, bool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
