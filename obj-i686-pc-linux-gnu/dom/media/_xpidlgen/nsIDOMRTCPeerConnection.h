/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/dom/media/nsIDOMRTCPeerConnection.idl
 */
...
class NS_NO_VTABLE nsIDOMRTCPeerConnection : public nsISupports {
 public: 
  ...
  NS_IMETHOD AddIceCandidate(nsIDOMRTCIceCandidate *candidate) = 0;
...
#define NS_DECL_NSIDOMRTCPEERCONNECTION \
  ...
  NS_IMETHOD AddIceCandidate(nsIDOMRTCIceCandidate *candidate); \
...
#define NS_FORWARD_NSIDOMRTCPEERCONNECTION(_to) \
  ...
  NS_IMETHOD AddIceCandidate(nsIDOMRTCIceCandidate *candidate) { return _to AddIceCandidate(candidate); } \
...
#define NS_FORWARD_SAFE_NSIDOMRTCPEERCONNECTION(_to) \
  ...
  NS_IMETHOD AddIceCandidate(nsIDOMRTCIceCandidate *candidate) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddIceCandidate(candidate); } \
...
/* void addIceCandidate (in nsIDOMRTCIceCandidate candidate); */
NS_IMETHODIMP nsDOMRTCPeerConnection::AddIceCandidate(nsIDOMRTCIceCandidate *candidate)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
