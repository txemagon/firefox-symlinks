...
static bool
get_length(JSContext* cx, JSHandleObject obj, nsClientRectList* self, JS::Value* vp)
{
  uint32_t result;
  result = self->Length();
...
const JSJitInfo length_getterinfo = {
  ...
  prototypes::id::ClientRectList,
  PrototypeTraits<prototypes::id::ClientRectList>::Depth,
  JSJitInfo::Getter,
...
static bool
item(JSContext* cx, JSHandleObject obj, nsClientRectList* self, unsigned argc, JS::Value* vp)
{

  if (argc < 1) {
    return ThrowErrorMessage(cx, MSG_MISSING_ARGUMENTS, "ClientRectList.item");
  }
...
genericMethod(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  nsClientRectList* self;
  {
    nsresult rv = UnwrapObject<prototypes::id::ClientRectList, nsClientRectList>(cx, obj, self);
    if (NS_FAILED(rv)) {
      return ThrowErrorMessage(cx, MSG_DOES_NOT_IMPLEMENT_INTERFACE, "ClientRectList");
    }
  }
...
const NativePropertyHooks sNativePropertyHooks = {
  ...
  prototypes::id::ClientRectList,
  constructors::id::ClientRectList,
  NULL
};
...
CreateInterfaceObjects(JSContext* aCx, JSObject* aGlobal, JSObject** protoAndIfaceArray)
{
  ...
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              &PrototypeClass.mBase, &protoAndIfaceArray[prototypes::id::ClientRectList],
                              nullptr, &_constructor_holder, 0, &protoAndIfaceArray[constructors::id::ClientRectList],
                              &Class,
                              &sNativeProperties,
...
MOZ_ALWAYS_INLINE nsClientRectList*
UnwrapProxy(JSObject* obj)
{
  ...
  return static_cast<nsClientRectList*>(js::GetProxyPrivate(obj).toPrivate());
}


const DOMClass Class = {
  { prototypes::id::ClientRectList, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  true,
  &sNativePropertyHooks,
  GetParentObject<nsClientRectList>::Get,
  GetProtoObject,
  nullptr
};
...
{
  return mozilla::dom::DOMProxyHandler::obj_toString(cx, "ClientRectList");
}
...
{
  MOZ_ASSERT(static_cast<nsClientRectList*>(aObject) ==
             reinterpret_cast<nsClientRectList*>(aObject));
