...
static bool
get_length(JSContext* cx, JSHandleObject obj, nsDOMCSSValueList* self, JS::Value* vp)
{
  uint32_t result;
  result = self->Length();
...
const JSJitInfo length_getterinfo = {
  ...
  prototypes::id::CSSValueList,
  PrototypeTraits<prototypes::id::CSSValueList>::Depth,
  JSJitInfo::Getter,
...
static bool
item(JSContext* cx, JSHandleObject obj, nsDOMCSSValueList* self, unsigned argc, JS::Value* vp)
{

  if (argc < 1) {
    return ThrowErrorMessage(cx, MSG_MISSING_ARGUMENTS, "CSSValueList.item");
  }
...
genericMethod(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  nsDOMCSSValueList* self;
  {
    nsresult rv = UnwrapObject<prototypes::id::CSSValueList, nsDOMCSSValueList>(cx, obj, self);
    if (NS_FAILED(rv)) {
      return ThrowErrorMessage(cx, MSG_DOES_NOT_IMPLEMENT_INTERFACE, "CSSValueList");
    }
  }
...
_hasInstance(JSContext* cx, JSHandleObject obj, JSMutableHandleValue vp, JSBool* bp)
{
  ...
  nsCOMPtr<nsIDOMCSSValueList> qiResult = do_QueryInterface(native);
  *bp = !!qiResult;
  return true;
...
CreateInterfaceObjects(JSContext* aCx, JSObject* aGlobal, JSObject** protoAndIfaceArray)
{
  ...
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              &PrototypeClass.mBase, &protoAndIfaceArray[prototypes::id::CSSValueList],
                              &InterfaceObjectClass.mBase, nullptr, 0, &protoAndIfaceArray[constructors::id::CSSValueList],
                              &Class,
                              &sNativeProperties,
                              nullptr,
                              "CSSValueList");
...
MOZ_ALWAYS_INLINE nsDOMCSSValueList*
UnwrapProxy(JSObject* obj)
{
  ...
  return static_cast<nsDOMCSSValueList*>(js::GetProxyPrivate(obj).toPrivate());
}


const DOMClass Class = {
  { prototypes::id::CSSValue, prototypes::id::CSSValueList, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  true,
  &sNativePropertyHooks,
  GetParentObject<nsDOMCSSValueList>::Get,
  GetProtoObject,
  nullptr
};
...
DOMProxyHandler::getOwnPropertyDescriptor(JSContext* cx, JSObject* proxy, jsid id, JSPropertyDescriptor* desc, unsigned flags)
{
  ...
  if (!(flags & JSRESOLVE_ASSIGNING)) {
    if (IsArrayIndex(index)) {
      nsDOMCSSValueList* self = UnwrapProxy(proxy);
      bool found;
      nsRefPtr<mozilla::dom::CSSValue> result;
...
{
  return mozilla::dom::DOMProxyHandler::obj_toString(cx, "CSSValueList");
}
...
{
  MOZ_ASSERT(static_cast<nsDOMCSSValueList*>(aObject) ==
             reinterpret_cast<nsDOMCSSValueList*>(aObject));
