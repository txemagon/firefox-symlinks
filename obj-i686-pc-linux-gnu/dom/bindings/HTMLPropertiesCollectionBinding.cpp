...
static bool
namedItem(JSContext* cx, JSHandleObject obj, mozilla::dom::HTMLPropertiesCollection* self, unsigned argc, JS::Value* vp)
{

  if (argc < 1) {
    return ThrowErrorMessage(cx, MSG_MISSING_ARGUMENTS, "HTMLPropertiesCollection.namedItem");
  }
  ...
  mozilla::dom::PropertyNodeList* result;
  result = self->NamedItem(arg0);
  if (!result) {
    *vp = JSVAL_NULL;
    return true;
  }
...
const JSJitInfo namedItem_methodinfo = {
  ...
  prototypes::id::HTMLPropertiesCollection,
  PrototypeTraits<prototypes::id::HTMLPropertiesCollection>::Depth,
  JSJitInfo::Method,
...
static bool
get_names(JSContext* cx, JSHandleObject obj, mozilla::dom::HTMLPropertiesCollection* self, JS::Value* vp)
{
...
const JSJitInfo names_getterinfo = {
  (JSJitPropertyOp)get_names,
  prototypes::id::HTMLPropertiesCollection,
  PrototypeTraits<prototypes::id::HTMLPropertiesCollection>::Depth,
  JSJitInfo::Getter,
  false,  /* isInfallible. False in setters. */
...
genericMethod(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  mozilla::dom::HTMLPropertiesCollection* self;
  {
    nsresult rv = UnwrapObject<prototypes::id::HTMLPropertiesCollection, mozilla::dom::HTMLPropertiesCollection>(cx, obj, self);
    if (NS_FAILED(rv)) {
      return ThrowErrorMessage(cx, MSG_DOES_NOT_IMPLEMENT_INTERFACE, "HTMLPropertiesCollection");
    }
  }
...
static JSPropertySpec sAttributes_specs[] = {
  { "names", 0, JSPROP_SHARED | JSPROP_ENUMERATE | JSPROP_NATIVE_ACCESSORS, { (JSPropertyOp)genericGetter, &names_getterinfo }, JSOP_NULLWRAPPER},
...
const NativePropertyHooks sNativePropertyHooks = {
  ...
  prototypes::id::HTMLPropertiesCollection,
  constructors::id::HTMLPropertiesCollection,
...
static DOMIfaceAndProtoJSClass PrototypeClass = {
  {
    "HTMLPropertiesCollectionPrototype",
...
CreateInterfaceObjects(JSContext* aCx, JSObject* aGlobal, JSObject** protoAndIfaceArray)
{
  ...
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              &PrototypeClass.mBase, &protoAndIfaceArray[prototypes::id::HTMLPropertiesCollection],
                              nullptr, &_constructor_holder, 0, &protoAndIfaceArray[constructors::id::HTMLPropertiesCollection],
                              &Class,
                              &sNativeProperties,
                              nullptr,
...
MOZ_ALWAYS_INLINE mozilla::dom::HTMLPropertiesCollection*
UnwrapProxy(JSObject* obj)
{
  ...
  return static_cast<mozilla::dom::HTMLPropertiesCollection*>(js::GetProxyPrivate(obj).toPrivate());
}


const DOMClass Class = {
  { prototypes::id::HTMLCollection, prototypes::id::HTMLPropertiesCollection, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  true,
  &sNativePropertyHooks,
  GetParentObject<mozilla::dom::HTMLPropertiesCollection>::Get,
  GetProtoObject,
  nullptr
};
...
DOMProxyHandler::getOwnPropertyDescriptor(JSContext* cx, JSObject* proxy, jsid id, JSPropertyDescriptor* desc, unsigned flags)
{
  ...
  if (!(flags & JSRESOLVE_ASSIGNING)) {
    if (IsArrayIndex(index)) {
      mozilla::dom::HTMLPropertiesCollection* self = UnwrapProxy(proxy);
      bool found;
...
{
  return mozilla::dom::DOMProxyHandler::obj_toString(cx, "HTMLPropertiesCollection");
}
...
{
  MOZ_ASSERT(static_cast<mozilla::dom::HTMLPropertiesCollection*>(aObject) ==
             reinterpret_cast<mozilla::dom::HTMLPropertiesCollection*>(aObject));
...
static bool
getValues(JSContext* cx, JSHandleObject obj, mozilla::dom::PropertyNodeList* self, unsigned argc, JS::Value* vp)
{
  ErrorResult rv;
  nsTArray< JS::Value > result;
  self->GetValues(cx, result, rv);
  if (rv.Failed()) {
    return ThrowMethodFailedWithDetails<true>(cx, rv, "PropertyNodeList", "getValues");
  }
...
const JSJitInfo getValues_methodinfo = {
  (JSJitPropertyOp)getValues,
  prototypes::id::PropertyNodeList,
  PrototypeTraits<prototypes::id::PropertyNodeList>::Depth,
  JSJitInfo::Method,
  false,  /* isInfallible. False in setters. */
  false,  /* isConstant. Only relevant for getters. */
  JSVAL_TYPE_OBJECT   /* returnType.  Only relevant for getters/methods. */
...
genericMethod(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  mozilla::dom::PropertyNodeList* self;
  {
    nsresult rv = UnwrapObject<prototypes::id::PropertyNodeList, mozilla::dom::PropertyNodeList>(cx, obj, self);
    if (NS_FAILED(rv)) {
      return ThrowErrorMessage(cx, MSG_DOES_NOT_IMPLEMENT_INTERFACE, "PropertyNodeList");
    }
  }
  const JSJitInfo *info = FUNCTION_VALUE_TO_JITINFO(JS_CALLEE(cx, vp));
  MOZ_ASSERT(info->type == JSJitInfo::Method);
...
static JSFunctionSpec sMethods_specs[] = {
  JS_FNINFO("getValues", genericMethod, &getValues_methodinfo, 0, JSPROP_ENUMERATE),
  JS_FS_END
};
...
const NativePropertyHooks sNativePropertyHooks = {
  ...
  { &sNativeProperties, nullptr },
  prototypes::id::PropertyNodeList,
  constructors::id::PropertyNodeList,
  &NodeListBinding::sNativePropertyHooks
};
...
CreateInterfaceObjects(JSContext* aCx, JSObject* aGlobal, JSObject** protoAndIfaceArray)
{
  JSObject* parentProto = NodeListBinding::GetProtoObject(aCx, aGlobal);
  if (!parentProto) {
    return;
  }
  ...
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              &PrototypeClass.mBase, &protoAndIfaceArray[prototypes::id::PropertyNodeList],
                              nullptr, &_constructor_holder, 0, &protoAndIfaceArray[constructors::id::PropertyNodeList],
                              &Class,
                              &sNativeProperties,
                              nullptr,
                              "PropertyNodeList");
...
MOZ_ALWAYS_INLINE mozilla::dom::PropertyNodeList*
UnwrapProxy(JSObject* obj)
{
  if (xpc::WrapperFactory::IsXrayWrapper(obj)) {
    obj = js::UnwrapObject(obj);
  ...
  MOZ_ASSERT(IsProxy(obj));
  return static_cast<mozilla::dom::PropertyNodeList*>(js::GetProxyPrivate(obj).toPrivate());
}


const DOMClass Class = {
  { prototypes::id::NodeList, prototypes::id::PropertyNodeList, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  true,
  &sNativePropertyHooks,
  GetParentObject<mozilla::dom::PropertyNodeList>::Get,
  GetProtoObject,
  nullptr
};
...
DOMProxyHandler::getOwnPropertyDescriptor(JSContext* cx, JSObject* proxy, jsid id, JSPropertyDescriptor* desc, unsigned flags)
{
  ...
  if (!(flags & JSRESOLVE_ASSIGNING)) {
    if (IsArrayIndex(index)) {
      mozilla::dom::PropertyNodeList* self = UnwrapProxy(proxy);
      bool found;
      nsINode* result;
      result = self->IndexedGetter(index, found);
...
DOMProxyHandler::obj_toString(JSContext* cx, JSObject* proxy)
{
  return mozilla::dom::DOMProxyHandler::obj_toString(cx, "PropertyNodeList");
}
...
{
  MOZ_ASSERT(static_cast<mozilla::dom::PropertyNodeList*>(aObject) ==
             reinterpret_cast<mozilla::dom::PropertyNodeList*>(aObject));
