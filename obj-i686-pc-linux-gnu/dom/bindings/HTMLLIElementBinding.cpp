...
static bool
get_value(JSContext* cx, JSHandleObject obj, mozilla::dom::HTMLLIElement* self, JS::Value* vp)
{
  int32_t result;
  result = self->Value();
...
static bool
set_value(JSContext* cx, JSHandleObject obj, mozilla::dom::HTMLLIElement* self, JS::Value* argv)
{
  int32_t arg0;
  ...
  if (rv.Failed()) {
    return ThrowMethodFailedWithDetails<true>(cx, rv, "HTMLLIElement", "value");
  }
...
static bool
get_type(JSContext* cx, JSHandleObject obj, mozilla::dom::HTMLLIElement* self, JS::Value* vp)
{
  nsString result;
  self->GetType(result);
...
static bool
set_type(JSContext* cx, JSHandleObject obj, mozilla::dom::HTMLLIElement* self, JS::Value* argv)
{
  ...
  if (rv.Failed()) {
    return ThrowMethodFailedWithDetails<true>(cx, rv, "HTMLLIElement", "type");
  }
...
genericGetter(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  mozilla::dom::HTMLLIElement* self;
  {
    nsresult rv = UnwrapObject<prototypes::id::HTMLLIElement, mozilla::dom::HTMLLIElement>(cx, obj, self);
    if (NS_FAILED(rv)) {
      return ThrowErrorMessage(cx, MSG_DOES_NOT_IMPLEMENT_INTERFACE, "HTMLLIElement");
    }
  }
...
genericSetter(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  if (argc == 0) {
    return ThrowErrorMessage(cx, MSG_MISSING_ARGUMENTS, "HTMLLIElement attribute setter");
  }
...
{
  MOZ_STATIC_ASSERT((IsBaseOf<nsISupports, mozilla::dom::HTMLLIElement>::value), "Must be an nsISupports class");
  mozilla::dom::HTMLLIElement* self = UnwrapDOMObject<mozilla::dom::HTMLLIElement>(obj);
...
_hasInstance(JSContext* cx, JSHandleObject obj, JSMutableHandleValue vp, JSBool* bp)
{
  ...
  nsCOMPtr<nsIDOMHTMLLIElement> qiResult = do_QueryInterface(native);
  *bp = !!qiResult;
  return true;
...
CreateInterfaceObjects(JSContext* aCx, JSObject* aGlobal, JSObject** protoAndIfaceArray)
{
  ...
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              &PrototypeClass.mBase, &protoAndIfaceArray[prototypes::id::HTMLLIElement],
                              &InterfaceObjectClass.mBase, nullptr, 0, &protoAndIfaceArray[constructors::id::HTMLLIElement],
                              &Class.mClass,
                              &sNativeProperties,
                              nullptr,
                              "HTMLLIElement");
...
DOMJSClass Class = {
  ...
  {
    { prototypes::id::EventTarget, prototypes::id::Node, prototypes::id::Element, prototypes::id::HTMLElement, prototypes::id::HTMLLIElement, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
    true,
    &sNativePropertyHooks,
    GetParentObject<mozilla::dom::HTMLLIElement>::Get,
    GetProtoObject,
    nullptr
  }
};
