...
{
  MOZ_STATIC_ASSERT((IsBaseOf<nsISupports, mozilla::dom::SVGGElement>::value), "Must be an nsISupports class");
  mozilla::dom::SVGGElement* self = UnwrapDOMObject<mozilla::dom::SVGGElement>(obj);
...
const NativePropertyHooks sNativePropertyHooks = {
  ...
  nullptr,
  { nullptr, nullptr },
  prototypes::id::SVGGElement,
  constructors::id::SVGGElement,
...
CreateInterfaceObjects(JSContext* aCx, JSObject* aGlobal, JSObject** protoAndIfaceArray)
{
  ...
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              &PrototypeClass.mBase, &protoAndIfaceArray[prototypes::id::SVGGElement],
                              nullptr, &_constructor_holder, 0, &protoAndIfaceArray[constructors::id::SVGGElement],
                              &Class.mClass,
                              nullptr,
                              nullptr,
                              "SVGGElement");
...
DOMJSClass Class = {
  ...
  {
    { prototypes::id::EventTarget, prototypes::id::Node, prototypes::id::Element, prototypes::id::SVGElement, prototypes::id::SVGLocatableElement, prototypes::id::SVGTransformableElement, prototypes::id::SVGGraphicsElement, prototypes::id::SVGGElement, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
    true,
    &sNativePropertyHooks,
    GetParentObject<mozilla::dom::SVGGElement>::Get,
    GetProtoObject,
    nullptr
  }
};
...
{
  MOZ_ASSERT(static_cast<mozilla::dom::SVGGElement*>(aObject) ==
             reinterpret_cast<mozilla::dom::SVGGElement*>(aObject));
