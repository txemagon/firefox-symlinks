...
static bool
get_align(JSContext* cx, JSHandleObject obj, mozilla::dom::HTMLHeadingElement* self, JS::Value* vp)
{
  nsString result;
...
static bool
set_align(JSContext* cx, JSHandleObject obj, mozilla::dom::HTMLHeadingElement* self, JS::Value* argv)
{
...
const JSJitInfo align_getterinfo = {
  ...
  prototypes::id::HTMLHeadingElement,
  PrototypeTraits<prototypes::id::HTMLHeadingElement>::Depth,
  JSJitInfo::Getter,
...
genericGetter(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  mozilla::dom::HTMLHeadingElement* self;
  {
    nsresult rv = UnwrapObject<prototypes::id::HTMLHeadingElement, mozilla::dom::HTMLHeadingElement>(cx, obj, self);
    if (NS_FAILED(rv)) {
      return ThrowErrorMessage(cx, MSG_DOES_NOT_IMPLEMENT_INTERFACE, "HTMLHeadingElement");
    }
  }
...
genericSetter(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  if (argc == 0) {
    return ThrowErrorMessage(cx, MSG_MISSING_ARGUMENTS, "HTMLHeadingElement attribute setter");
  }
...
{
  MOZ_STATIC_ASSERT((IsBaseOf<nsISupports, mozilla::dom::HTMLHeadingElement>::value), "Must be an nsISupports class");
  mozilla::dom::HTMLHeadingElement* self = UnwrapDOMObject<mozilla::dom::HTMLHeadingElement>(obj);
...
const NativePropertyHooks sNativePropertyHooks = {
  ...
  prototypes::id::HTMLHeadingElement,
  constructors::id::HTMLHeadingElement,
...
_hasInstance(JSContext* cx, JSHandleObject obj, JSMutableHandleValue vp, JSBool* bp)
{
  ...
  nsCOMPtr<nsIDOMHTMLHeadingElement> qiResult = do_QueryInterface(native);
  *bp = !!qiResult;
  return true;
...
CreateInterfaceObjects(JSContext* aCx, JSObject* aGlobal, JSObject** protoAndIfaceArray)
{
  ...
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              &PrototypeClass.mBase, &protoAndIfaceArray[prototypes::id::HTMLHeadingElement],
                              &InterfaceObjectClass.mBase, nullptr, 0, &protoAndIfaceArray[constructors::id::HTMLHeadingElement],
                              &Class.mClass,
                              &sNativeProperties,
                              nullptr,
                              "HTMLHeadingElement");
...
DOMJSClass Class = {
  ...
  {
    { prototypes::id::EventTarget, prototypes::id::Node, prototypes::id::Element, prototypes::id::HTMLElement, prototypes::id::HTMLHeadingElement, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
    true,
    &sNativePropertyHooks,
    GetParentObject<mozilla::dom::HTMLHeadingElement>::Get,
    GetProtoObject,
    nullptr
  }
};
...
{
  MOZ_ASSERT(static_cast<mozilla::dom::HTMLHeadingElement*>(aObject) ==
             reinterpret_cast<mozilla::dom::HTMLHeadingElement*>(aObject));
