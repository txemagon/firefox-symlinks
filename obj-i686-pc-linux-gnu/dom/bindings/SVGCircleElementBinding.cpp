...
static bool
get_cx(JSContext* cx, JSHandleObject obj, mozilla::dom::SVGCircleElement* self, JS::Value* vp)
{
...
static bool
get_cy(JSContext* cx, JSHandleObject obj, mozilla::dom::SVGCircleElement* self, JS::Value* vp)
{
  nsRefPtr<nsIDOMSVGAnimatedLength> result;
  result = self->Cy();
  if (!WrapObject(cx, obj, result, vp)) {
...
static bool
get_r(JSContext* cx, JSHandleObject obj, mozilla::dom::SVGCircleElement* self, JS::Value* vp)
{
  nsRefPtr<nsIDOMSVGAnimatedLength> result;
  result = self->R();
  if (!WrapObject(cx, obj, result, vp)) {
...
const JSJitInfo r_getterinfo = {
  (JSJitPropertyOp)get_r,
  prototypes::id::SVGCircleElement,
  PrototypeTraits<prototypes::id::SVGCircleElement>::Depth,
  JSJitInfo::Getter,
  false,  /* isInfallible. False in setters. */
...
genericGetter(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  mozilla::dom::SVGCircleElement* self;
  {
    nsresult rv = UnwrapObject<prototypes::id::SVGCircleElement, mozilla::dom::SVGCircleElement>(cx, obj, self);
    if (NS_FAILED(rv)) {
      return ThrowErrorMessage(cx, MSG_DOES_NOT_IMPLEMENT_INTERFACE, "SVGCircleElement");
    }
  }
...
{
  MOZ_STATIC_ASSERT((IsBaseOf<nsISupports, mozilla::dom::SVGCircleElement>::value), "Must be an nsISupports class");
  mozilla::dom::SVGCircleElement* self = UnwrapDOMObject<mozilla::dom::SVGCircleElement>(obj);
...
static JSPropertySpec sAttributes_specs[] = {
  ...
  { "r", 0, JSPROP_SHARED | JSPROP_ENUMERATE | JSPROP_NATIVE_ACCESSORS, { (JSPropertyOp)genericGetter, &r_getterinfo }, JSOP_NULLWRAPPER},
...
CreateInterfaceObjects(JSContext* aCx, JSObject* aGlobal, JSObject** protoAndIfaceArray)
{
  ...
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              &PrototypeClass.mBase, &protoAndIfaceArray[prototypes::id::SVGCircleElement],
                              nullptr, &_constructor_holder, 0, &protoAndIfaceArray[constructors::id::SVGCircleElement],
                              &Class.mClass,
                              &sNativeProperties,
                              nullptr,
                              "SVGCircleElement");
...
DOMJSClass Class = {
  ...
  {
    { prototypes::id::EventTarget, prototypes::id::Node, prototypes::id::Element, prototypes::id::SVGElement, prototypes::id::SVGLocatableElement, prototypes::id::SVGTransformableElement, prototypes::id::SVGGraphicsElement, prototypes::id::SVGCircleElement, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
    true,
    &sNativePropertyHooks,
    GetParentObject<mozilla::dom::SVGCircleElement>::Get,
    GetProtoObject,
    nullptr
  }
};
