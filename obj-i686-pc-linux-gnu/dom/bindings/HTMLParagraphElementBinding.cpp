...
static bool
get_align(JSContext* cx, JSHandleObject obj, mozilla::dom::HTMLParagraphElement* self, JS::Value* vp)
{
  nsString result;
...
static bool
set_align(JSContext* cx, JSHandleObject obj, mozilla::dom::HTMLParagraphElement* self, JS::Value* argv)
{
  ...
  if (rv.Failed()) {
    return ThrowMethodFailedWithDetails<true>(cx, rv, "HTMLParagraphElement", "align");
  }
...
genericGetter(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  mozilla::dom::HTMLParagraphElement* self;
  {
    nsresult rv = UnwrapObject<prototypes::id::HTMLParagraphElement, mozilla::dom::HTMLParagraphElement>(cx, obj, self);
    if (NS_FAILED(rv)) {
      return ThrowErrorMessage(cx, MSG_DOES_NOT_IMPLEMENT_INTERFACE, "HTMLParagraphElement");
    }
  }
...
genericSetter(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  if (argc == 0) {
    return ThrowErrorMessage(cx, MSG_MISSING_ARGUMENTS, "HTMLParagraphElement attribute setter");
  }
...
{
  MOZ_STATIC_ASSERT((IsBaseOf<nsISupports, mozilla::dom::HTMLParagraphElement>::value), "Must be an nsISupports class");
  mozilla::dom::HTMLParagraphElement* self = UnwrapDOMObject<mozilla::dom::HTMLParagraphElement>(obj);
...
_hasInstance(JSContext* cx, JSHandleObject obj, JSMutableHandleValue vp, JSBool* bp)
{
  ...
  nsCOMPtr<nsIDOMHTMLParagraphElement> qiResult = do_QueryInterface(native);
  *bp = !!qiResult;
  return true;
...
CreateInterfaceObjects(JSContext* aCx, JSObject* aGlobal, JSObject** protoAndIfaceArray)
{
  ...
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              &PrototypeClass.mBase, &protoAndIfaceArray[prototypes::id::HTMLParagraphElement],
                              &InterfaceObjectClass.mBase, nullptr, 0, &protoAndIfaceArray[constructors::id::HTMLParagraphElement],
                              &Class.mClass,
                              &sNativeProperties,
                              nullptr,
                              "HTMLParagraphElement");
...
DOMJSClass Class = {
  ...
  {
    { prototypes::id::EventTarget, prototypes::id::Node, prototypes::id::Element, prototypes::id::HTMLElement, prototypes::id::HTMLParagraphElement, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
    true,
    &sNativePropertyHooks,
    GetParentObject<mozilla::dom::HTMLParagraphElement>::Get,
    GetProtoObject,
    nullptr
  }
};
