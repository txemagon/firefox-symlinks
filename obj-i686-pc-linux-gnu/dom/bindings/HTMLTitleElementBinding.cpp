...
static bool
get_text(JSContext* cx, JSHandleObject obj, mozilla::dom::HTMLTitleElement* self, JS::Value* vp)
{
  nsString result;
  self->GetText(result);
...
static bool
set_text(JSContext* cx, JSHandleObject obj, mozilla::dom::HTMLTitleElement* self, JS::Value* argv)
{
  ...
  if (rv.Failed()) {
    return ThrowMethodFailedWithDetails<true>(cx, rv, "HTMLTitleElement", "text");
  }
...
genericGetter(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  mozilla::dom::HTMLTitleElement* self;
  {
    nsresult rv = UnwrapObject<prototypes::id::HTMLTitleElement, mozilla::dom::HTMLTitleElement>(cx, obj, self);
    if (NS_FAILED(rv)) {
      return ThrowErrorMessage(cx, MSG_DOES_NOT_IMPLEMENT_INTERFACE, "HTMLTitleElement");
    }
  }
...
genericSetter(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  if (argc == 0) {
    return ThrowErrorMessage(cx, MSG_MISSING_ARGUMENTS, "HTMLTitleElement attribute setter");
  }
...
{
  MOZ_STATIC_ASSERT((IsBaseOf<nsISupports, mozilla::dom::HTMLTitleElement>::value), "Must be an nsISupports class");
  mozilla::dom::HTMLTitleElement* self = UnwrapDOMObject<mozilla::dom::HTMLTitleElement>(obj);
...
CreateInterfaceObjects(JSContext* aCx, JSObject* aGlobal, JSObject** protoAndIfaceArray)
{
  ...
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              &PrototypeClass.mBase, &protoAndIfaceArray[prototypes::id::HTMLTitleElement],
                              nullptr, &_constructor_holder, 0, &protoAndIfaceArray[constructors::id::HTMLTitleElement],
                              &Class.mClass,
                              &sNativeProperties,
                              nullptr,
                              "HTMLTitleElement");
...
DOMJSClass Class = {
  ...
  {
    { prototypes::id::EventTarget, prototypes::id::Node, prototypes::id::Element, prototypes::id::HTMLElement, prototypes::id::HTMLTitleElement, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
    true,
    &sNativePropertyHooks,
    GetParentObject<mozilla::dom::HTMLTitleElement>::Get,
    GetProtoObject,
    nullptr
  }
};
