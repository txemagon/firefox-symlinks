...
static bool
item(JSContext* cx, JSHandleObject obj, nsINodeList* self, unsigned argc, JS::Value* vp)
{
...
static bool
get_length(JSContext* cx, JSHandleObject obj, nsINodeList* self, JS::Value* vp)
{
  uint32_t result;
  result = self->Length();
...
genericMethod(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  nsINodeList* self;
  {
    nsresult rv = UnwrapObject<prototypes::id::NodeList, nsINodeList>(cx, obj, self);
    if (NS_FAILED(rv)) {
      return ThrowErrorMessage(cx, MSG_DOES_NOT_IMPLEMENT_INTERFACE, "NodeList");
    }
  }
...
CreateInterfaceObjects(JSContext* aCx, JSObject* aGlobal, JSObject** protoAndIfaceArray)
{
  ...
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              &PrototypeClass.mBase, &protoAndIfaceArray[prototypes::id::NodeList],
                              nullptr, &_constructor_holder, 0, &protoAndIfaceArray[constructors::id::NodeList],
                              &Class,
                              &sNativeProperties,
...
const DOMClass Class = {
  { prototypes::id::NodeList, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  true,
  &sNativePropertyHooks,
  GetParentObject<nsINodeList>::Get,
  GetProtoObject,
  nullptr
};
...
{
  return mozilla::dom::DOMProxyHandler::obj_toString(cx, "NodeList");
}
