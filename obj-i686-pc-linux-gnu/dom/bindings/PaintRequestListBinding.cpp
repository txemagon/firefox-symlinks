...
static bool
get_length(JSContext* cx, JSHandleObject obj, nsPaintRequestList* self, JS::Value* vp)
{
  uint32_t result;
  result = self->Length();
...
static bool
item(JSContext* cx, JSHandleObject obj, nsPaintRequestList* self, unsigned argc, JS::Value* vp)
{

  if (argc < 1) {
    return ThrowErrorMessage(cx, MSG_MISSING_ARGUMENTS, "PaintRequestList.item");
  }
...
genericMethod(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  nsPaintRequestList* self;
  {
    nsresult rv = UnwrapObject<prototypes::id::PaintRequestList, nsPaintRequestList>(cx, obj, self);
    if (NS_FAILED(rv)) {
      return ThrowErrorMessage(cx, MSG_DOES_NOT_IMPLEMENT_INTERFACE, "PaintRequestList");
    }
  }
...
CreateInterfaceObjects(JSContext* aCx, JSObject* aGlobal, JSObject** protoAndIfaceArray)
{
  ...
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              &PrototypeClass.mBase, &protoAndIfaceArray[prototypes::id::PaintRequestList],
                              nullptr, &_constructor_holder, 0, &protoAndIfaceArray[constructors::id::PaintRequestList],
                              &Class,
                              &sNativeProperties,
...
MOZ_ALWAYS_INLINE nsPaintRequestList*
UnwrapProxy(JSObject* obj)
{
  ...
  return static_cast<nsPaintRequestList*>(js::GetProxyPrivate(obj).toPrivate());
}


const DOMClass Class = {
  { prototypes::id::PaintRequestList, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  true,
  &sNativePropertyHooks,
  GetParentObject<nsPaintRequestList>::Get,
  GetProtoObject,
  nullptr
};
...
DOMProxyHandler::getOwnPropertyDescriptor(JSContext* cx, JSObject* proxy, jsid id, JSPropertyDescriptor* desc, unsigned flags)
{
  ...
  if (!(flags & JSRESOLVE_ASSIGNING)) {
    if (IsArrayIndex(index)) {
      nsPaintRequestList* self = UnwrapProxy(proxy);
      bool found;
      nsPaintRequest* result;
...
{
  return mozilla::dom::DOMProxyHandler::obj_toString(cx, "PaintRequestList");
}
...
{
  MOZ_ASSERT(static_cast<nsPaintRequestList*>(aObject) ==
             reinterpret_cast<nsPaintRequestList*>(aObject));
