...
static bool
get_align(JSContext* cx, JSHandleObject obj, mozilla::dom::HTMLDivElement* self, JS::Value* vp)
{
  nsString result;
...
static bool
set_align(JSContext* cx, JSHandleObject obj, mozilla::dom::HTMLDivElement* self, JS::Value* argv)
{
  ...
  if (rv.Failed()) {
    return ThrowMethodFailedWithDetails<true>(cx, rv, "HTMLDivElement", "align");
  }
...
const JSJitInfo align_getterinfo = {
  ...
  prototypes::id::HTMLDivElement,
  PrototypeTraits<prototypes::id::HTMLDivElement>::Depth,
  JSJitInfo::Getter,
...
genericGetter(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  mozilla::dom::HTMLDivElement* self;
  {
    nsresult rv = UnwrapObject<prototypes::id::HTMLDivElement, mozilla::dom::HTMLDivElement>(cx, obj, self);
    if (NS_FAILED(rv)) {
      return ThrowErrorMessage(cx, MSG_DOES_NOT_IMPLEMENT_INTERFACE, "HTMLDivElement");
    }
  }
...
genericSetter(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  if (argc == 0) {
    return ThrowErrorMessage(cx, MSG_MISSING_ARGUMENTS, "HTMLDivElement attribute setter");
  }
...
{
  MOZ_STATIC_ASSERT((IsBaseOf<nsISupports, mozilla::dom::HTMLDivElement>::value), "Must be an nsISupports class");
  mozilla::dom::HTMLDivElement* self = UnwrapDOMObject<mozilla::dom::HTMLDivElement>(obj);
...
const NativePropertyHooks sNativePropertyHooks = {
  ...
  prototypes::id::HTMLDivElement,
  constructors::id::HTMLDivElement,
...
_hasInstance(JSContext* cx, JSHandleObject obj, JSMutableHandleValue vp, JSBool* bp)
{
  ...
  nsCOMPtr<nsIDOMHTMLDivElement> qiResult = do_QueryInterface(native);
  *bp = !!qiResult;
  return true;
...
CreateInterfaceObjects(JSContext* aCx, JSObject* aGlobal, JSObject** protoAndIfaceArray)
{
  ...
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              &PrototypeClass.mBase, &protoAndIfaceArray[prototypes::id::HTMLDivElement],
                              &InterfaceObjectClass.mBase, nullptr, 0, &protoAndIfaceArray[constructors::id::HTMLDivElement],
                              &Class.mClass,
                              &sNativeProperties,
                              nullptr,
                              "HTMLDivElement");
...
DOMJSClass Class = {
  ...
  {
    { prototypes::id::EventTarget, prototypes::id::Node, prototypes::id::Element, prototypes::id::HTMLElement, prototypes::id::HTMLDivElement, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
    true,
    &sNativePropertyHooks,
    GetParentObject<mozilla::dom::HTMLDivElement>::Get,
    GetProtoObject,
    nullptr
  }
};
...
{
  MOZ_ASSERT(static_cast<mozilla::dom::HTMLDivElement*>(aObject) ==
             reinterpret_cast<mozilla::dom::HTMLDivElement*>(aObject));
