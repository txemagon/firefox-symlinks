/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/dom/interfaces/core/nsIDOMElement.idl
 */
...
#define NS_IDOMELEMENT_IID_STR "f1465e67-577f-4546-a7a3-bb1293c0dd15"

#define NS_IDOMELEMENT_IID \
  {0xf1465e67, 0x577f, 0x4546, \
    { 0xa7, 0xa3, 0xbb, 0x12, 0x93, 0xc0, 0xdd, 0x15 }}
...
class NS_NO_VTABLE nsIDOMElement : public nsIDOMNode {
 public: 
  ...
  NS_IMETHOD GetClassList(nsIDOMDOMTokenList * *aClassList) = 0;
...
#define NS_DECL_NSIDOMELEMENT \
  ...
  NS_IMETHOD GetClassList(nsIDOMDOMTokenList * *aClassList); \
...
#define NS_FORWARD_NSIDOMELEMENT(_to) \
  ...
  NS_IMETHOD GetClassList(nsIDOMDOMTokenList * *aClassList) { return _to GetClassList(aClassList); } \
...
#define NS_FORWARD_SAFE_NSIDOMELEMENT(_to) \
  ...
  NS_IMETHOD GetClassList(nsIDOMDOMTokenList * *aClassList) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetClassList(aClassList); } \
