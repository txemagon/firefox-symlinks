/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/dom/interfaces/core/nsIDOMDOMSettableTokenList.idl
 */
...
class NS_NO_VTABLE nsIDOMDOMSettableTokenList : public nsIDOMDOMTokenList {
 public: 
