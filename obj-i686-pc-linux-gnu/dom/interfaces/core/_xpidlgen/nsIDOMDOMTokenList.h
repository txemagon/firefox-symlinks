/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/dom/interfaces/core/nsIDOMDOMTokenList.idl
 */
...
class NS_NO_VTABLE nsIDOMDOMTokenList : public nsISupports {
 public: 
  ...
  NS_IMETHOD Contains(const nsAString & token, bool *_retval) = 0;

  /* void add ([Null (Stringify)] in DOMString token); */
  NS_IMETHOD Add(const nsAString & token) = 0;

  /* void remove ([Null (Stringify)] in DOMString token); */
  NS_IMETHOD Remove(const nsAString & token) = 0;

  /* boolean toggle ([Null (Stringify)] in DOMString token); */
  NS_IMETHOD Toggle(const nsAString & token, bool *_retval) = 0;
...
#define NS_DECL_NSIDOMDOMTOKENLIST \
  ...
  NS_IMETHOD Contains(const nsAString & token, bool *_retval); \
  NS_IMETHOD Add(const nsAString & token); \
  NS_IMETHOD Remove(const nsAString & token); \
  NS_IMETHOD Toggle(const nsAString & token, bool *_retval); \
...
#define NS_FORWARD_NSIDOMDOMTOKENLIST(_to) \
  ...
  NS_IMETHOD Contains(const nsAString & token, bool *_retval) { return _to Contains(token, _retval); } \
  NS_IMETHOD Add(const nsAString & token) { return _to Add(token); } \
  NS_IMETHOD Remove(const nsAString & token) { return _to Remove(token); } \
  NS_IMETHOD Toggle(const nsAString & token, bool *_retval) { return _to Toggle(token, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMDOMTOKENLIST(_to) \
  ...
  NS_IMETHOD Contains(const nsAString & token, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Contains(token, _retval); } \
  NS_IMETHOD Add(const nsAString & token) { return !_to ? NS_ERROR_NULL_POINTER : _to->Add(token); } \
  NS_IMETHOD Remove(const nsAString & token) { return !_to ? NS_ERROR_NULL_POINTER : _to->Remove(token); } \
  NS_IMETHOD Toggle(const nsAString & token, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Toggle(token, _retval); } \
...
/* readonly attribute unsigned long length; */
NS_IMETHODIMP nsDOMDOMTokenList::GetLength(uint32_t *aLength)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [binaryname(MozItem)] DOMString item (in unsigned long index); */
NS_IMETHODIMP nsDOMDOMTokenList::MozItem(uint32_t index, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean contains ([Null (Stringify)] in DOMString token); */
NS_IMETHODIMP nsDOMDOMTokenList::Contains(const nsAString & token, bool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean toggle ([Null (Stringify)] in DOMString token); */
NS_IMETHODIMP nsDOMDOMTokenList::Toggle(const nsAString & token, bool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* DOMString toString (); */
NS_IMETHODIMP nsDOMDOMTokenList::ToString(nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
