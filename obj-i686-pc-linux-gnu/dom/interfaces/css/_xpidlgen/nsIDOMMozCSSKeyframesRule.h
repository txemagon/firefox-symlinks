/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/dom/interfaces/css/nsIDOMMozCSSKeyframesRule.idl
 */
...
class NS_NO_VTABLE nsIDOMMozCSSKeyframesRule : public nsIDOMCSSRule {
 public: 
  ...
  NS_IMETHOD InsertRule(const nsAString & rule) = 0;
...
#define NS_DECL_NSIDOMMOZCSSKEYFRAMESRULE \
  ...
  NS_IMETHOD InsertRule(const nsAString & rule); \
...
#define NS_FORWARD_NSIDOMMOZCSSKEYFRAMESRULE(_to) \
  ...
  NS_IMETHOD InsertRule(const nsAString & rule) { return _to InsertRule(rule); } \
...
#define NS_FORWARD_SAFE_NSIDOMMOZCSSKEYFRAMESRULE(_to) \
  ...
  NS_IMETHOD InsertRule(const nsAString & rule) { return !_to ? NS_ERROR_NULL_POINTER : _to->InsertRule(rule); } \
