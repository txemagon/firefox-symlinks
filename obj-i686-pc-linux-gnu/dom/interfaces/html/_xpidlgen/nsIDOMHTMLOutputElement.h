/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/dom/interfaces/html/nsIDOMHTMLOutputElement.idl
 */
...
class NS_NO_VTABLE nsIDOMHTMLOutputElement : public nsIDOMHTMLElement {
 public: 
  ...
  NS_IMETHOD GetHtmlFor(nsIDOMDOMSettableTokenList * *aHtmlFor) = 0;
...
#define NS_DECL_NSIDOMHTMLOUTPUTELEMENT \
  NS_IMETHOD GetHtmlFor(nsIDOMDOMSettableTokenList * *aHtmlFor); \
...
#define NS_FORWARD_NSIDOMHTMLOUTPUTELEMENT(_to) \
  NS_IMETHOD GetHtmlFor(nsIDOMDOMSettableTokenList * *aHtmlFor) { return _to GetHtmlFor(aHtmlFor); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLOUTPUTELEMENT(_to) \
  NS_IMETHOD GetHtmlFor(nsIDOMDOMSettableTokenList * *aHtmlFor) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHtmlFor(aHtmlFor); } \
