/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/dom/interfaces/traversal/nsIDOMNodeIterator.idl
 */
...
class NS_NO_VTABLE nsIDOMNodeIterator : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetExpandEntityReferences(bool *aExpandEntityReferences) = 0;
...
#define NS_DECL_NSIDOMNODEITERATOR \
  ...
  NS_IMETHOD GetExpandEntityReferences(bool *aExpandEntityReferences); \
...
#define NS_FORWARD_NSIDOMNODEITERATOR(_to) \
  ...
  NS_IMETHOD GetExpandEntityReferences(bool *aExpandEntityReferences) { return _to GetExpandEntityReferences(aExpandEntityReferences); } \
...
#define NS_FORWARD_SAFE_NSIDOMNODEITERATOR(_to) \
  ...
  NS_IMETHOD GetExpandEntityReferences(bool *aExpandEntityReferences) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetExpandEntityReferences(aExpandEntityReferences); } \
