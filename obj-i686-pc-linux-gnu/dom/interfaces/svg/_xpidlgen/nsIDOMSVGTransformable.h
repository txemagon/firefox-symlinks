/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/dom/interfaces/svg/nsIDOMSVGTransformable.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGTransformable : public nsIDOMSVGLocatable {
 public: 
  ...
  NS_IMETHOD GetTransform(nsISupports * *aTransform) = 0;
...
#define NS_DECL_NSIDOMSVGTRANSFORMABLE \
  NS_IMETHOD GetTransform(nsISupports * *aTransform); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSVGTRANSFORMABLE(_to) \
  NS_IMETHOD GetTransform(nsISupports * *aTransform) { return _to GetTransform(aTransform); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGTRANSFORMABLE(_to) \
  NS_IMETHOD GetTransform(nsISupports * *aTransform) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTransform(aTransform); } 
...
/* readonly attribute nsISupports transform; */
NS_IMETHODIMP nsDOMSVGTransformable::GetTransform(nsISupports * *aTransform)
{
