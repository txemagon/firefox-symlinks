/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/dom/interfaces/svg/nsIDOMSVGElement.idl
 */
...
/* nsIDOMCSSValue getPresentationAttribute (in DOMString name); */
NS_IMETHODIMP nsDOMSVGElement::GetPresentationAttribute(const nsAString & name, nsIDOMCSSValue * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
