/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/dom/interfaces/smil/nsIDOMElementTimeControl.idl
 */
...
class NS_NO_VTABLE nsIDOMElementTimeControl : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMELEMENTTIMECONTROL_IID)

  /* void beginElement (); */
  NS_IMETHOD BeginElement(void) = 0;

  /* void beginElementAt (in float offset); */
  NS_IMETHOD BeginElementAt(float offset) = 0;

  /* void endElement (); */
  NS_IMETHOD EndElement(void) = 0;

  /* void endElementAt (in float offset); */
  NS_IMETHOD EndElementAt(float offset) = 0;
...
#define NS_DECL_NSIDOMELEMENTTIMECONTROL \
  NS_IMETHOD BeginElement(void); \
  NS_IMETHOD BeginElementAt(float offset); \
  NS_IMETHOD EndElement(void); \
  NS_IMETHOD EndElementAt(float offset); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMELEMENTTIMECONTROL(_to) \
  NS_IMETHOD BeginElement(void) { return _to BeginElement(); } \
  NS_IMETHOD BeginElementAt(float offset) { return _to BeginElementAt(offset); } \
  NS_IMETHOD EndElement(void) { return _to EndElement(); } \
  NS_IMETHOD EndElementAt(float offset) { return _to EndElementAt(offset); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMELEMENTTIMECONTROL(_to) \
  NS_IMETHOD BeginElement(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->BeginElement(); } \
  NS_IMETHOD BeginElementAt(float offset) { return !_to ? NS_ERROR_NULL_POINTER : _to->BeginElementAt(offset); } \
  NS_IMETHOD EndElement(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->EndElement(); } \
  NS_IMETHOD EndElementAt(float offset) { return !_to ? NS_ERROR_NULL_POINTER : _to->EndElementAt(offset); } 
