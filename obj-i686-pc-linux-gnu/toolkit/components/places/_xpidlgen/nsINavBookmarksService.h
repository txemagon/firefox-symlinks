/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/toolkit/components/places/nsINavBookmarksService.idl
 */
...
class NS_NO_VTABLE nsINavBookmarkObserver : public nsISupports {
 public: 
  ...
  NS_IMETHOD OnBeforeItemRemoved(int64_t aItemId, uint16_t aItemType, int64_t aParentId, const nsACString & aGUID, const nsACString & aParentGUID) = 0;
...
#define NS_DECL_NSINAVBOOKMARKOBSERVER \
  ...
  NS_IMETHOD OnBeforeItemRemoved(int64_t aItemId, uint16_t aItemType, int64_t aParentId, const nsACString & aGUID, const nsACString & aParentGUID); \
...
#define NS_FORWARD_NSINAVBOOKMARKOBSERVER(_to) \
  ...
  NS_IMETHOD OnBeforeItemRemoved(int64_t aItemId, uint16_t aItemType, int64_t aParentId, const nsACString & aGUID, const nsACString & aParentGUID) { return _to OnBeforeItemRemoved(aItemId, aItemType, aParentId, aGUID, aParentGUID); } \
...
#define NS_FORWARD_SAFE_NSINAVBOOKMARKOBSERVER(_to) \
  ...
  NS_IMETHOD OnBeforeItemRemoved(int64_t aItemId, uint16_t aItemType, int64_t aParentId, const nsACString & aGUID, const nsACString & aParentGUID) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnBeforeItemRemoved(aItemId, aItemType, aParentId, aGUID, aParentGUID); } \
...
/* void onBeforeItemRemoved (in long long aItemId, in unsigned short aItemType, in long long aParentId, in ACString aGUID, in ACString aParentGUID); */
NS_IMETHODIMP nsNavBookmarkObserver::OnBeforeItemRemoved(int64_t aItemId, uint16_t aItemType, int64_t aParentId, const nsACString & aGUID, const nsACString & aParentGUID)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
