/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/toolkit/components/places/nsINavHistoryService.idl
 */
...
class NS_NO_VTABLE nsINavHistoryFullVisitResultNode : public nsINavHistoryVisitResultNode {
 public: 
  ...
  NS_IMETHOD GetReferringVisitId(int64_t *aReferringVisitId) = 0;

  /* readonly attribute long transitionType; */
  NS_IMETHOD GetTransitionType(int32_t *aTransitionType) = 0;
...
#define NS_FORWARD_NSINAVHISTORYFULLVISITRESULTNODE(_to) \
  ...
  NS_IMETHOD GetReferringVisitId(int64_t *aReferringVisitId) { return _to GetReferringVisitId(aReferringVisitId); } \
  NS_IMETHOD GetTransitionType(int32_t *aTransitionType) { return _to GetTransitionType(aTransitionType); } 
...
#define NS_FORWARD_SAFE_NSINAVHISTORYFULLVISITRESULTNODE(_to) \
  ...
  NS_IMETHOD GetReferringVisitId(int64_t *aReferringVisitId) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetReferringVisitId(aReferringVisitId); } \
  NS_IMETHOD GetTransitionType(int32_t *aTransitionType) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTransitionType(aTransitionType); } 
...
/* readonly attribute long long visitId; */
NS_IMETHODIMP nsNavHistoryFullVisitResultNode::GetVisitId(int64_t *aVisitId)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute long long referringVisitId; */
NS_IMETHODIMP nsNavHistoryFullVisitResultNode::GetReferringVisitId(int64_t *aReferringVisitId)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute long transitionType; */
NS_IMETHODIMP nsNavHistoryFullVisitResultNode::GetTransitionType(int32_t *aTransitionType)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE nsINavHistoryResultObserver : public nsISupports {
 public: 
  ...
  NS_IMETHOD NodeReplaced(nsINavHistoryContainerResultNode *aParentNode, nsINavHistoryResultNode *aOldNode, nsINavHistoryResultNode *aNewNode, uint32_t aIndex) = 0;
...
#define NS_DECL_NSINAVHISTORYRESULTOBSERVER \
  ...
  NS_IMETHOD NodeReplaced(nsINavHistoryContainerResultNode *aParentNode, nsINavHistoryResultNode *aOldNode, nsINavHistoryResultNode *aNewNode, uint32_t aIndex); \
...
#define NS_FORWARD_NSINAVHISTORYRESULTOBSERVER(_to) \
  ...
  NS_IMETHOD NodeReplaced(nsINavHistoryContainerResultNode *aParentNode, nsINavHistoryResultNode *aOldNode, nsINavHistoryResultNode *aNewNode, uint32_t aIndex) { return _to NodeReplaced(aParentNode, aOldNode, aNewNode, aIndex); } \
...
#define NS_FORWARD_SAFE_NSINAVHISTORYRESULTOBSERVER(_to) \
  ...
  NS_IMETHOD NodeReplaced(nsINavHistoryContainerResultNode *aParentNode, nsINavHistoryResultNode *aOldNode, nsINavHistoryResultNode *aNewNode, uint32_t aIndex) { return !_to ? NS_ERROR_NULL_POINTER : _to->NodeReplaced(aParentNode, aOldNode, aNewNode, aIndex); } \
...
/* void nodeReplaced (in nsINavHistoryContainerResultNode aParentNode, in nsINavHistoryResultNode aOldNode, in nsINavHistoryResultNode aNewNode, in unsigned long aIndex); */
NS_IMETHODIMP nsNavHistoryResultObserver::NodeReplaced(nsINavHistoryContainerResultNode *aParentNode, nsINavHistoryResultNode *aOldNode, nsINavHistoryResultNode *aNewNode, uint32_t aIndex)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#define NS_INAVHISTORYOBSERVER_IID_STR "e4d40863-ee3c-4094-9fc0-18c3245d97ef"

#define NS_INAVHISTORYOBSERVER_IID \
  {0xe4d40863, 0xee3c, 0x4094, \
    { 0x9f, 0xc0, 0x18, 0xc3, 0x24, 0x5d, 0x97, 0xef }}
...
class NS_NO_VTABLE nsINavHistoryObserver : public nsISupports {
 public: 
  ...
  NS_IMETHOD OnBeforeDeleteURI(nsIURI *aURI, const nsACString & aGUID, uint16_t aReason) = 0;
...
#define NS_DECL_NSINAVHISTORYOBSERVER \
  ...
  NS_IMETHOD OnBeforeDeleteURI(nsIURI *aURI, const nsACString & aGUID, uint16_t aReason); \
...
#define NS_FORWARD_NSINAVHISTORYOBSERVER(_to) \
  ...
  NS_IMETHOD OnBeforeDeleteURI(nsIURI *aURI, const nsACString & aGUID, uint16_t aReason) { return _to OnBeforeDeleteURI(aURI, aGUID, aReason); } \
...
#define NS_FORWARD_SAFE_NSINAVHISTORYOBSERVER(_to) \
  ...
  NS_IMETHOD OnBeforeDeleteURI(nsIURI *aURI, const nsACString & aGUID, uint16_t aReason) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnBeforeDeleteURI(aURI, aGUID, aReason); } \
...
/* void onBeforeDeleteURI (in nsIURI aURI, in ACString aGUID, in unsigned short aReason); */
NS_IMETHODIMP nsNavHistoryObserver::OnBeforeDeleteURI(nsIURI *aURI, const nsACString & aGUID, uint16_t aReason)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
