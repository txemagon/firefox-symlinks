/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/txema/work/firefox-20.0+build1/toolkit/mozapps/update/nsIUpdateService.idl
 */
...
class NS_NO_VTABLE nsIUpdateCheckListener : public nsISupports {
 public: 
  ...
  NS_IMETHOD OnProgress(nsIXMLHttpRequest *request, uint32_t position, uint32_t totalSize) = 0;
...
#define NS_DECL_NSIUPDATECHECKLISTENER \
  NS_IMETHOD OnProgress(nsIXMLHttpRequest *request, uint32_t position, uint32_t totalSize); \
...
#define NS_FORWARD_NSIUPDATECHECKLISTENER(_to) \
  NS_IMETHOD OnProgress(nsIXMLHttpRequest *request, uint32_t position, uint32_t totalSize) { return _to OnProgress(request, position, totalSize); } \
...
#define NS_FORWARD_SAFE_NSIUPDATECHECKLISTENER(_to) \
  NS_IMETHOD OnProgress(nsIXMLHttpRequest *request, uint32_t position, uint32_t totalSize) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnProgress(request, position, totalSize); } \
...
/* void onProgress (in nsIXMLHttpRequest request, in unsigned long position, in unsigned long totalSize); */
NS_IMETHODIMP nsUpdateCheckListener::OnProgress(nsIXMLHttpRequest *request, uint32_t position, uint32_t totalSize)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
